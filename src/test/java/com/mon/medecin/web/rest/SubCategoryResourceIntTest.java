...
import com.mon.medecin.domain.SubCategory;
import com.mon.medecin.repository.SubCategoryRepository;
import com.mon.medecin.repository.search.SubCategorySearchRepository;
...
public class SubCategoryResourceIntTest {
    ...
    public void createSubCategory() throws Exception {
        ...
        assertThat(subCategoryEs).isEqualToIgnoringGivenFields(testSubCategory);
    }
